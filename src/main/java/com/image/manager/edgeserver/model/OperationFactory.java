...
public class OperationFactory {
    ...
    public List<Operation> fromQuery(String wholeQuery) {
        if (wholeQuery != null) {
    ...
    private static Operation fromSubQuery(String query) {
    ...
    private static Operation fromOperationAndArguments(OperationType operationType, Map<String, Integer> arguments) {
        return switch (operationType) {
            case CROP -> CropOperation.fromArgumentsMap(arguments);
            case SCALE -> ScaleOperation.fromArgumentsMap(arguments);
        };
    }
}
